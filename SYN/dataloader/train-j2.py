...
def main():
    ...
    for epoch in range(num_epoch):
        ...
        torchvision.utils.save_image(torchvision.utils.make_grid(img_grid_hm_two_cams_stack, pad_value=1, nrow=clip_len), '/ubc/cs/home/h/heyizhuo/syncode/SYN/cam1&2_epoch{}.png'.format(epoch))
...
def test(test_loader, model, test_writer):
    ...
    print ("The test accuracy is {:.4f}".format(test_distance))
