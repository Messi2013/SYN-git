...
class SYN(Dataset):
    ...
    def __init__(self, train=True,
        ...
        print("this is after sorting", self.video_cam2)
        ...
        for n in range(len(self.video_cam1)): # len(self.video_cam1) is: 38
            ...
            group_name_cam1 = sorted(os.listdir(each_video_path_cam1))
            group_name_cam2 = sorted(os.listdir(each_video_path_cam2))
